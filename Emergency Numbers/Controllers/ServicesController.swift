...
class ServicesController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UISearchBarDelegate {
    ...
    lazy var refreshControl: UIRefreshControl = {
        ...
        refreshControl.addTarget(self, action: #selector(ServicesController.handleRefresh(_:)), for: UIControlEvents.valueChanged)
    ...
    override func viewWillAppear(_ animated: Bool) {
        NotificationCenter.default.addObserver(self, selector: #selector(ServicesController.loadData), name: NSNotification.Name(rawValue: "addedNewNumber"), object: nil)
